...
# os.environ['http_proxy'] = 'http_proxy=http://10.11.81.73:7890;'
# os.environ['https_proxy'] = 'https_proxy=http://10.11.81.73:7890;'


# Create a database connection
# kwargs = {'host': '192.168.235.101', 'username': 'ads_ka_rd', 'password': 'ka_rd_7b65e6_dev', 'database': 'ads_ka', 'port': 9030} # test
kwargs = {'host': '192.168.39.104', 'username': 'ads_ka_rd', 'password': 'ads_ka_rd@13b705', 'database': 'ads_ka', 'port': 9030 } # prod
