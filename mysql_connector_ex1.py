...
# Set up the proxy
socks.set_default_proxy(socks.SOCKS5, "10.11.81.73", 9870)
...
kwargs = {'host': '192.168.39.104', 'username': 'ads_ka_rd', 'password': 'ads_ka_rd@13b705', 'database': 'ads_ka', 'port': 9030
        } # prod
